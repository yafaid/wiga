...
@section('judul_halaman', 'Presensi Harian')
@section('header')
    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-md-12 mt-2 mb-2 d-flex flex-row-reverse">
                <a href="{{ route('harian.view') }}" id="tambahButton" class="btn btn-icon icon-left btn-primary">
                    Lihat Data</a>
            </div>
        </div>
    ...
    <script>
        ...
        function changeKelas(val) {
            ...
            if (tanggal == '') {
                ...
                $('#kode_kelas').val('').trigger(
                    'change.select2'); // Change the value or make some change to the internal state
                return;
            }
            $.ajax({
                url: "{{ route('get.siswa') }}",
